...
# 添加 CPAgent 工具路径
sys.path.append("/data5/home/xiechenyu2023/project/ChartQA/CPAgent/tools")
...
try:
    ...
    print(f"警告：无法导入 CPAgent 工具，请确保路径正确: {e}")
    # 定义空类作为备用
    class YOLOTool:
...
# 工具配置路径（基于 CPAgent 的默认路径）
KPD_AXIS_PATH = "/data5/home/xiechenyu2023/project/ChartQA/CPAgent/tools/checkpoint/kpd_axis.pt"
KPD_PIE_PATH = "/data5/home/xiechenyu2023/project/ChartQA/CPAgent/tools/checkpoint/kpd_pie.pt"
SEG_VERTICAL_BAR_PATH = "/data5/home/xiechenyu2023/project/ChartQA/CPAgent/tools/checkpoint/yolo_vertical_bar.pt"
SEG_HORIZONTAL_BAR_PATH = "/data5/home/xiechenyu2023/project/ChartQA/CPAgent/tools/checkpoint/yolo_horizontal_bar.pt"
